...
<body class="loginbody">
    ...
    <div class="loginwrapper1">
        ...
        <h1 class="logintitle"><span class="iconfa-lock"></span>SIAS SMP KREASINDO TEGAL<span class="subtitle">Silahkan Guru login untuk memulai !!!!</span></h1>
            <div class="loginwrapperinner">
				<?php include("loginguru.php") ?>
