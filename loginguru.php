...
<form id="loginform" action="indexguru.php?login_attempt=1" method="post">
...
{
	$spf=sprintf("Select * from guru where username='%s' and password='%s'",$_POST['username'],md5($_POST['password']));
	$rs=mysql_query($spf);
