...
<body class="loginbody">
    ...
    <div class="loginwrapper1">
        ...
        <h1 class="logintitle"><span class="iconfa-lock"></span>SIAS SMP KREASINDO TEGAL<span class="subtitle">Silahkan Siswa login untuk memulai !!!!</span></h1>
            <div class="loginwrapperinner">
				<?php include("loginsiswa.php") ?>
    ...
    jQuery(document).ready(function(){
        ...
        jQuery('#ni,#password').focus(function(){
            if(jQuery(this).hasClass('error')) jQuery(this).removeClass('error');
        });
        
        jQuery('#loginform button').click(function(){
            if(!jQuery.browser.msie) {
                if(jQuery('#ni').val() == '' || jQuery('#password').val() == '') {
                    if(jQuery('#ni').val() == '') jQuery('#ni').addClass('error'); else jQuery('#ni').removeClass('error');
