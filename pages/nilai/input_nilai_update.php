...
if(isset($_POST['submit'])){
	...
	for ($i=1; $i<=$jumSis; $i++)
	{
	   ...
	   $query = "update tbl_nilai set nilai_uh1='$nilai_uh1', nilai_uh2='$nilai_uh2', nilai_uh3='$nilai_uh3', nilai_uh4='$nilai_uh4', rata_uh='$rata_uh' where id_siswa='$id_siswa' and id_mapel='$id_mapel' and kelas='$kelas' and id_guru='$id_guru'";
...
<tr>
    ...
    <div id="content-table-inner">
      ...
      <br />
        ...
        <?php
		$view=mysql_query("SELECT * FROM tbl_nilai nilai, data_siswa siswa WHERE nilai.id_siswa=siswa.id_siswa and nilai.id_guru='$id_guru' and nilai.kelas='$kelas' and nilai.id_mapel='$id_mapel' order by siswa.nama_siswa asc");
		...
		while($row=mysql_fetch_array($view)){
            ...
            <tr>
                ...
                <td><?php echo "<input type='text' name='rata_uh".$i."' size='10' value='".$row['rata_uh']."'/>"; ?></td>
			</tr>
			<?php
			$i++;
		}
			$jumSis = $i-1;
		?>
        <input type="text" name="jumlah" value="<?php echo $jumSis ?>" />
        <tr>
